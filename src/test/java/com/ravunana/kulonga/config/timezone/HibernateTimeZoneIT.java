package com.ravunana.kulonga.config.timezone;

import com.ravunana.kulonga.KulongaApp;
import com.ravunana.kulonga.repository.timezone.DateTimeWrapper;
import com.ravunana.kulonga.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM rv_date_time_wrapper where id=%d", fieldName, id);
    }
